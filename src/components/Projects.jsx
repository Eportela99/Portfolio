        ...
        <div className="featured-project glass-card fade-in">
          <div className="featured-info">
            ...
            <div className="featured-footer">
              ...
              <a href={featured.github} className="project-link featured-gh" aria-label="GitHub" target="_blank" rel="noreferrer">
                <GitHubIcon />
          ...
          <div className="featured-img-wrap">
            <img src={winToolkitImg} alt="WinToolkit v2.0 screenshot" className="featured-img" />
          </div>
        </div>
        ...
        <div className="featured-project featured-project-rev glass-card fade-in">
          ...
          <div className="featured-info">
            ...
            <div className="featured-footer">
              ...
              <a href="https://github.com/Eportela99/GitTree" className="project-link featured-gh" aria-label="GitHub" target="_blank" rel="noreferrer">
                <GitHubIcon />
                <span>View on GitHub</span>
              </a>
            </div>
        ...
        <div className="featured-project glass-card fade-in">
          <div className="featured-info">
            ...
            <div className="featured-footer">
              ...
              <a href="https://github.com/Eportela99/IT-DockTools" className="project-link featured-gh" aria-label="GitHub" target="_blank" rel="noreferrer">
                <GitHubIcon />
                <span>View on GitHub</span>
              </a>
            </div>
